...
puts "Abstracting /tmp/tmp2_4vpngq/repo/gds/user_project_wrapper.gds"
...
X2_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells and delete all their subcell instances.
	load $cell
