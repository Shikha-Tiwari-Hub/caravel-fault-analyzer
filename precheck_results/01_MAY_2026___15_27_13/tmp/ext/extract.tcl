...
foreach cell { X2_sky130_fd_sc_hd__fill_1
X2_sky130_fd_sc_hd__fill_2
X2_sky130_fd_sc_hd__fill_4
X2_sky130_fd_sc_hd__fill_8
X2_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Load abstract cells
	if { [file exists /tmp/tmp2_4vpngq/repo/precheck_results/01_MAY_2026___15_27_13/tmp/ext/$cell.lef] } {
		puts "Using abstracted $cell"
		lef read /tmp/tmp2_4vpngq/repo/precheck_results/01_MAY_2026___15_27_13/tmp/ext/$cell.lef
	}
}
...
puts "\nExtracting /tmp/tmp2_4vpngq/repo/gds/user_project_wrapper.gds"
gds read /tmp/tmp2_4vpngq/repo/gds/user_project_wrapper.gds
cd /tmp/tmp2_4vpngq/repo/precheck_results/01_MAY_2026___15_27_13/tmp/ext
...
X2_sky130_fd_sc_hd__fill_4
X2_sky130_fd_sc_hd__fill_8
X2_sky130_fd_sc_hd__tapvpwrvgnd_1 } { ;# Set abstract cells
	load $cell
